package com.medicine.medicinetime.addmedicine;
...
import com.medicine.medicinetime.R;
import com.medicine.medicinetime.alarm.ReminderActivity;
import com.medicine.medicinetime.alarm.ReminderFragment;
import com.medicine.medicinetime.data.source.MedicineAlarm;
import com.medicine.medicinetime.data.source.Pills;
import com.medicine.medicinetime.views.DayViewCheckBox;
import com.medicine.medicinetime.views.RobotoBoldTextView;
...
public class AddMedicineFragment extends Fragment implements AddMedicineContract.View {
    ...
    View.OnClickListener setClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            for (int i = 0; i < 7; i++) {
                if (dayOfWeekList[i] && !pill_name.isEmpty()) {
